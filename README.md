...
次数制約がない場合は、カタラン数に一致することが確認できる。k=2の場合は、この数はモツキン数となり、それと一致する。k=3 ~ 10の場合については、[oeis](https://oeis.org/)にこの問題設定と同等の問題設定のページがあり([A036765](https://oeis.org/A036765)等)一致することが確認できる。
